...
raw_bucket_minIO = "metis/analysis-a22afdb473bcd/raw"

if minio_client.bucket_exists("metis") == False:
        minio_client.make_bucket("metis")

minio_client.fput_object(
    "metis", "analysis-a22afdb473bcd/raw/test_analysis1.txt", "test_analysis1.txt"
)
minio_client.fput_object(
    "metis", "analysis-a22afdb473bcd/raw/test_analysis2.txt", "test_analysis2.txt"
)
...
@sio.on("speak")
def speak():
    diastema_playbook = playbook
    sio.emit("analysis", diastema_playbook) # Send to server
